        ...
        <main class="auth">
            ...
            <div class="auth__content">
                <div class="auth__content-inner">
                    ...
                    <form action="${pageContext.request.contextPath}/sign-in" method="post" class="form auth__form">
                     <p class="auth__desc" style="color: red">${errorString } </p>
                        ...
                        <div class="form__group auth__btn-group">
                            <button type="submit" class="btn btn--primary auth__btn form__submit-btn">Sign In</button>
